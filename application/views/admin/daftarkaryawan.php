                ...
                <div class="col-sm-12 col-md-12 main">
                  <div class="box-tools pull-right">
                    <div class="input-group input-group-sm" style="width: 150px;">
                      <a href="<?php echo base_url('register_karyawan')?>" class="btn btn-primary">
                  ...
                  <?php foreach ($karyawan as $inputkaryawan): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <form class="" action="<?php echo base_url('admin/delete_karyawan')?>" method="post">
                          <!-- kelima -->
                          <button type="button" class="btn btn-warning" onclick="edit_karyawan('<?php echo $inputkaryawan->id_karyawan;?>')">
                            <i class="fa fa-edit"></i> Edit
                          </button>
                          <input type="hidden" name="id_karyawan" value="<?php echo $inputkaryawan->id_karyawan; ?>">
                          <button type="submit" class="btn btn-danger" name="hapus_karyawan">
