...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form class="" action="<?php echo base_url('admin/create_penyuplaian') ?>" method="post">
        <div class="row">
                  ...
                  <div class="sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main">
                    <div class="container">
                      <div class="row">
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Jumlah</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="jumlah">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Tanggal Pembelian</label>
                            <div class="col-md-5">
                              <input type="date" class="form-control" id="" placeholder="" required="true" name="tgl_pembelian">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Total Bayar</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="total_bayar">
                            </div>
                          </div>
                        </div>
                        <div class="row">
