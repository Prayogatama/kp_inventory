                  ...
                  <div class="sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main">
                    <div class="container">
                      <div class="row">
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Nama Barang</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="nama_barang">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Keterangan</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="keterangan_barang">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Jenis Barang</label>
                            <div class="col-md-5">
                              <select class="form-control" required="true" name="jenis_barang">
                        ...
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Harga</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="harga_barang">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Stok</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="stok_barang">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <p class="help-block">Ukuran max 2mb.</p>
                        </div>
                        <div class="row">
