      ...
      <div class="row">
        <div class="col-sm-12 col-md-12 main">
            ...
            <div class="box-header">
              <h1 class="box-title">Daftar Pengiriman</h1>
                <div class="box-tools">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <form class="" action="" method="post">
                            <a href="daftarsupplier_edit.php?id_supplier=<?php echo $inputpengiriman->id_pengiriman; ?>" class="btn btn-warning">Edit</a>
                            <input type="hidden" name="id_supplier" value="<?php echo $inputpengiriman->id_pengiriman;  ?>">
