        ...
        <div class="col-sm-12 col-md-12 main">
          <div class="box">
            <div class="box-header">
              <h1 class="box-title">Daftar Penyuplaian</h1>
                <div class="box-tools">
                ...
                <div class="col-sm-12 col-md-12 main">
                  <div class="box-tools pull-right">
                    <div class="input-group input-group-sm" style="width: 150px;">
                      <a href="<?php echo base_url('inputpenyuplaian')?>" class="btn btn-primary">
                  ...
                  <?php foreach ($penyuplaian as $inputpenyuplaian):?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <form class="" action="<?php echo base_url('admin/delete_penyuplaian')?>" method="post">
                          <!-- kelima -->
                          <button type="button" class="btn btn-warning" onclick="edit_penyuplaian('<?php echo $inputpenyuplaian->id_penyuplaian;?>')">
                            <i class="fa fa-edit"></i> Edit
                          </button>
                          <input type="hidden" name="id_penyuplaian" value="<?php echo $inputpenyuplaian->id_penyuplaian; ?>">
                          <button type="submit" class="btn btn-danger" name="delete_penyuplaian">
