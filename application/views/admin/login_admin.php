...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('/dasboard')?>"><b>Inventory</b>Mitra</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in your account Admin</p>
    ...
    <a href="<?php echo base_url('/register_admin')?>" class="text-center">Register a new membership</a>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
