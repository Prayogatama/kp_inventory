...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form class="" action="<?php echo base_url('admin/create_supplier')?>" method="post">
        <div class="row">
                  ...
                  <div class="sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main">
                    <div class="container">
                      <div class="row">
                        <!-- <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Id Supplier</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="Id_supplier">
                            </div>
                          </div>
                        </div> -->
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Nama Supplier</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="nama_supplier">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <label class="col-md-2" for="">Alamat Supplier</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="alamat_supplier">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="nama_instansi">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <!-- <div class="row">
                            <label class="col-md-2" for="">ID Barang</label>
                            <div class="col-md-5">
                              <input type="text" class="form-control" id="" placeholder="" required="true" name="id_barang">
                            </div>
                          </div> -->
                        </div>
                        <div class="row">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="#">Mitar Rekatama</a>.</strong>
  </footer>
