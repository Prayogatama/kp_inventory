								    ...
								    <ul class="list3">
										<li>
											...
											<div class="extra-wrap">
											 <p>Jl. Koperasi Baja no.2 Ceper, Klaten, Indonesia 57465</p>
											</div>
										</li>
									</ul>
							    </div>
								<div class="col_1_of_bottom span_1_of_first1">
									...
									<ul class="list3">
										<li>
											...
											<div class="extra-wrap">
												<p><span>Telephone:</span>0272-551408</p>
											</div>
												<img src="<?php echo base_url('assets/images/fax.png')?>" alt="">
											<div class="extra-wrap">
												<p><span>FAX:</span>0272-551404</p>
											</div>
										</li>
									</ul>
								</div>
								<div class="col_1_of_bottom span_1_of_first1">
								    ...
								    <ul class="list3">
										<li>
											...
											<div class="extra-wrap">
											  <p><span class="mail"><a href="info@mitrarekatama.com">info@mitrarekatama.com</a></span></p>
											</div>
										</li>
									</ul>
							    </div>
